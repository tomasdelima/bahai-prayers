...
module.exports = React.createClass({
  ...
  renderScene (route, navigator) {
    ...
    else if (route.id == 'prayers')    {
      var categories = Array.unique(route.items.map((i) => i.category_id))
      return <List items={route.items} type={'prayers'} theme={this.props.theme} categoryId={categories.length == 1 ? categories[0] : null}/>
    }
